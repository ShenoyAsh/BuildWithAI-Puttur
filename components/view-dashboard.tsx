    ...
    <div className="space-y-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 relative z-10">
        ...
        <div className="glass-panel p-5 rounded-xl flex items-center justify-between shadow-sm">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mt-1">{pendingTasks}</h3>
            <p className="text-xs text-indigo-400 mt-1 flex items-center gap-1 cursor-pointer" onClick={() => setActiveTab("tasks")}>
              View manager <ArrowRight size={10} />
            </p>
          </div>
          <div className="p-3 bg-zinc-900 border border-zinc-800 rounded-lg text-indigo-400">
        ...
        <div className="glass-panel p-5 rounded-xl flex items-center justify-between shadow-sm">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-1">Across {activeHabitsCount} active habits</p>
          </div>
        ...
        <div className="glass-panel p-5 rounded-xl flex items-center justify-between shadow-sm">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mt-1">{averagePlacementScore}%</h3>
            <p className="text-xs text-violet-400 mt-1 flex items-center gap-1 cursor-pointer" onClick={() => setActiveTab("placement")}>
              Practice LeetCode <ArrowRight size={10} />
            </p>
          </div>
          <div className="p-3 bg-zinc-900 border border-zinc-800 rounded-lg text-violet-400">
        ...
        <div className="glass-panel p-5 rounded-xl flex items-center justify-between shadow-sm">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-1">Long-term targets</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-panel p-6 rounded-xl space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-white">Focus & consistency curve</h3>
                <p className="text-xs text-zinc-400">Calculated based on habit streaks and task completions</p>
              </div>
          ...
          <div className="glass-panel p-6 rounded-xl space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-white">Urgent tasks due</h3>
              <button 
        ...
        <div className="space-y-6">
          ...
          {/* AI Suggestion box */}
          <div className="glass-panel p-6 rounded-xl border border-indigo-500/20 bg-gradient-to-b from-indigo-950/20 to-zinc-900/50 relative overflow-hidden">
              ...
              {goals.slice(0, 2).map((goal) => (
                <div key={goal.id} className="space-y-1">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-zinc-300 font-medium truncate">{goal.title}</span>
          ...
          {/* Recent reflections */}
          <div className="glass-panel p-6 rounded-xl space-y-4">
            <h3 className="text-lg font-semibold text-white">Recent reflection</h3>
